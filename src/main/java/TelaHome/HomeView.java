...
import controller.aluguel.AlugarController;
import controller.aluguel.DevolucaoController;
import controller.catalogo.AdicionarVeiculoController;
import controller.catalogo.ApagarVeiculoController;
import controller.catalogo.EditarVeiculoController;
import controller.catalogo.PesquisarVeiculoController;
import controller.cliente.AdicionarClienteController;
import controller.cliente.ApagarClienteController;
...
public class HomeView extends javax.swing.JFrame {
    ...
    private void miPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miPesquisarActionPerformed
        PesquisarVeiculoController pvc = new PesquisarVeiculoController(new PesquisarVeiculoView());
    ...
    private void miEditarVeiculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miEditarVeiculoActionPerformed
        EditarVeiculoController evc = new EditarVeiculoController(new EditarVeiculoView());
    ...
    private void miAlugarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miAlugarActionPerformed
        AlugarController ac = new AlugarController(new AlugarView());
    ...
    private void miDevolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miDevolverActionPerformed
        DevolucaoController dc = new DevolucaoController(new DevolucaoView());
    ...
    private void miAddClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miAddClienteActionPerformed
       AdicionarClienteController acc = new AdicionarClienteController(new AdicionarClienteView());
    ...
    private void miEditarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miEditarClienteActionPerformed
        EditarClienteController ecc = new EditarClienteController(new EditarClienteView());
    ...
    private void miApagarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miApagarClienteActionPerformed
        ApagarClienteController acc = new ApagarClienteController(new ApagarClienteView());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                try {
                    Cnh cnh1 = new Cnh("11111", 2025);
                    Cnh cnh2 = new Cnh("22222", 2025);
                    Cnh cnh3 = new Cnh("33333", 2025);
                    //Clintes
                    Cliente cliente1 = new Cliente("Filipe", "48 99999-9999", "11111111111", 20);
                    Cliente cliente2 = new Cliente("Henrique", "48 88888-8888", "22222222222", 21);
                    Cliente cliente3 = new Cliente("Arthur", "48 77777-7777", "33333333333", 19);
                    
                    cliente1.setCnh(cnh1);
                    cliente2.setCnh(cnh2);
                    cliente3.setCnh(cnh3);
                    
                    ClienteDAO.salvarCliente(cliente1);
                    ClienteDAO.salvarCliente(cliente2);
                    ClienteDAO.salvarCliente(cliente3);
                } catch (CPFException ex) {
                    JOptionPane.showMessageDialog(null, ex);
                } catch (CNHRegistroException ex) {
                    JOptionPane.showMessageDialog(null, ex);
                }

                Veiculo veiculo1 = new Carro("ABC123", "Telsa", "S3", 0, false, 520);
                Veiculo veiculo2 = new Carro("ABC456", "VW", "Fusca", 100000, false, 40);
                Veiculo veiculo3 = new Carro("ABC789", "Fiat", "Uno", 64000, false, 20);

                Veiculo veiculo4 = new Van("DEF123", "Fiat", "Doblo", 73000, false, 50);
                Veiculo veiculo5 = new Van("DEF456", "Chevrolet", "Vamaro", 14000, false, 35);
                Veiculo veiculo6 = new Van("DEF789", "Lamburghini", "Vanrricane", 0, false, 60);

                c1.addVeiculo(veiculo1);
                c1.addVeiculo(veiculo2);
                c1.addVeiculo(veiculo3);

                c2.addVeiculo(veiculo4);
                c2.addVeiculo(veiculo5);
                c2.addVeiculo(veiculo6);
                
                c1.addVeiculoMap(veiculo1);
                c1.addVeiculoMap(veiculo2);
                c1.addVeiculoMap(veiculo3);
                
                c2.addVeiculoMap(veiculo4);
                c2.addVeiculoMap(veiculo5);
                c2.addVeiculoMap(veiculo6);
